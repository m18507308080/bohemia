package com.nothin.bohemia.producer.website.xici.assigner;
...
import com.nothin.bohemia.producer.website.xici.task.XiciTask;

public class XiciAssinger implements
		ICrawlersTaskAssigner<BlockingQueue<String>> {

	private static Logger logger = Logger.getLogger(XiciAssinger.class);
	...
	public void doAssign() {
		...
		int threadCount = 10;
		logger.info(" [xici.net.co] 构建 [" + threadCount + "] 个线程 爬虫 开始工作 ");
		for (int i = 1; i <= threadCount; i++) {
			XiciTask task = new XiciTask();
