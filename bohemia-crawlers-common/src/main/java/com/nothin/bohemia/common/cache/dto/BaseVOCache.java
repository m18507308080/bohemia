 ...
 */
package com.nothin.bohemia.common.cache.dto;
 ...
 * @since [产品/模块版本] （可选）
 */
public class BaseVOCache implements Cache {
    ...
    public BaseVOCache(String name, IRedisClient springBinaryRedisClient) {
        this.name = name;
        this.springRedisClient = springBinaryRedisClient;
        this.expiration =defaultExpiration;
    }
  
    public BaseVOCache(String name, IRedisClient springBinaryRedisClient, int expiration) {
        this.name = name;
        this.springRedisClient = springBinaryRedisClient;
    ...
    public ValueWrapper get(Object key) {
        ...
        ValueWrapper valueWrapper = (object.isPresent() ? new SimpleValueWrapper(JSON.parseObject(object.get(),new TypeReference<List<Object>>(){})) : null);
        return valueWrapper ;
    }
